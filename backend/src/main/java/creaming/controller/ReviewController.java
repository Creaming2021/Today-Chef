...
public class ReviewController {
    ...
    public ResponseEntity<Page<ReviewDto.SimpleResponse>> getReviewAll(@RequestParam("courseId")UUID courseId,
                                          Pageable pageable) {
    ...
    public ResponseEntity<ReviewDto.DetailResponse> getReview(@PathVariable("reviewId") UUID reviewId) {
    ...
    public ResponseEntity<UUID> postReview(@RequestBody @Valid ReviewDto.PostRequest dto) {
    ...
    public ResponseEntity<Void> putReview(@PathVariable("reviewId") UUID reviewId,
    ...
    public ResponseEntity<UUID> postReviewComment(@PathVariable("reviewId") UUID reviewId,
        ...
        UUID result = reviewService.postReviewComment(reviewId, dto);
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }

    @PutMapping("/{reviewId}/comments/{commentId}")
    public ResponseEntity<Void> putReviewComment(@PathVariable("reviewId") UUID reviewId,
    ...
    public ResponseEntity<Void> deleteReviewComment(@PathVariable("reviewId") UUID reviewId,
                                                 @PathVariable("commentId") UUID commentId) {
