...
public class ProductQnaController {
    ...
    @GetMapping
    public ResponseEntity<List<ProductQnaDto.Response>> getProductQnaAll(@RequestParam("productId") Long id) {
    ...
    @PostMapping
    public ResponseEntity<Long> postProductQna(@RequestBody ProductQnaDto.PostRequest dto) {
    ...
    public ResponseEntity<Long> putProductQna(@PathVariable("productQnaId")Long id,
                                              @RequestBody ProductQnaDto.PutRequest dto) {
