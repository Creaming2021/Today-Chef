...
public class MemberController {
    ...
    @PutMapping("/{memberId}")
    public ResponseEntity<?> putMember(@PathVariable("memberId") Long memberId,
    ...
    public ResponseEntity<?> getCouponAll(@PathVariable("memberId") Long memberId) {
        List<MemberDto.Response> result = new ArrayList<>();
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    ...
    public ResponseEntity<?> useCoupon(@PathVariable("memberId") Long memberId,
    ...
    public ResponseEntity<?> getCourseStudent(@PathVariable("memberId") Long memberId) {
    ...
    public ResponseEntity<?> getCourseTeacher(@PathVariable("memberId") Long memberId) {
        List<CourseDto.SimpleResponse> result = new ArrayList<>();
        return ResponseEntity.status(HttpStatus.OK).body(result);
    }
    ...
    public ResponseEntity<?> getRegisterAll(@PathVariable("memberId") Long memberId) {
